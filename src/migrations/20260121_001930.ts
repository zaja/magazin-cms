...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('en', 'hr');
  ...
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('en', 'hr');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('en', 'hr');
  CREATE TYPE "public"."enum_users_roles" AS ENUM('admin', 'editor', 'author', 'subscriber');
  ...
  CREATE TYPE "public"."enum_settings_language" AS ENUM('en', 'hr');
  CREATE TYPE "public"."enum_settings_timezone" AS ENUM('Europe/Zagreb', 'Europe/London', 'America/New_York', 'UTC');
  CREATE TYPE "public"."enum_seo_structured_data_social_links_platform" AS ENUM('facebook', 'twitter', 'instagram', 'linkedin', 'youtube');
  CREATE TYPE "public"."enum_seo_sitemap_changefreq" AS ENUM('always', 'hourly', 'daily', 'weekly', 'monthly', 'yearly', 'never');
  CREATE TYPE "public"."enum_email_config_provider" AS ENUM('smtp', 'resend');
  ...
  CREATE TABLE "comments" (
  	...
  	"ip_address" varchar,
  	"user_agent" varchar,
  	"subscribed_to_replies" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "subscribers" (
  	...
  	"preferences_new_posts" boolean DEFAULT true,
  	"preferences_comment_replies" boolean DEFAULT true,
  ...
  CREATE TABLE "settings" (
  	...
  	"favicon_id" integer,
  	"domain" varchar,
  	"language" "enum_settings_language" DEFAULT 'en',
  	"timezone" "enum_settings_timezone" DEFAULT 'Europe/Zagreb',
  ...
  CREATE TABLE "settings_locales" (
  	"site_name" varchar DEFAULT 'Magazin CMS' NOT NULL,
  ...
  CREATE TABLE "seo_structured_data_social_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"platform" "enum_seo_structured_data_social_links_platform",
  	"url" varchar
  );
  ...
  CREATE TABLE "seo" (
  	...
  	"structured_data_organization_logo_id" integer,
  ...
  Sitemap: /sitemap.xml',
  	...
  	"sitemap_changefreq" "enum_seo_sitemap_changefreq" DEFAULT 'weekly',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "seo_structured_data_social_links" ADD CONSTRAINT "seo_structured_data_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."seo"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "seo" ADD CONSTRAINT "seo_structured_data_organization_logo_id_media_id_fk" FOREIGN KEY ("structured_data_organization_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "seo_structured_data_social_links_order_idx" ON "seo_structured_data_social_links" USING btree ("_order");
  CREATE INDEX "seo_structured_data_social_links_parent_id_idx" ON "seo_structured_data_social_links" USING btree ("_parent_id");
  CREATE INDEX "seo_default_og_image_idx" ON "seo" USING btree ("default_og_image_id");
  CREATE INDEX "seo_structured_data_structured_data_organization_logo_idx" ON "seo" USING btree ("structured_data_organization_logo_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "seo_structured_data_social_links" CASCADE;
  ...
  DROP TYPE "public"."enum_settings_language";
  DROP TYPE "public"."enum_settings_timezone";
  DROP TYPE "public"."enum_seo_structured_data_social_links_platform";
  DROP TYPE "public"."enum_seo_sitemap_changefreq";
  DROP TYPE "public"."enum_email_config_provider";`)
}
